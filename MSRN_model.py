...
class MSResNet(nn.Module):
    def __init__(self, layers, input_channel=4, num_classes=2):
        self.inplanes3 = 64
        self.inplanes5 = 64
        self.inplanes7 = 64
    ...
    def _make_layer3(self, block, planes, blocks, kernel_size, stride=2):
        ...
        layers = [block(self.inplanes3, planes, kernel_size, stride, downsample)]
    ...
    def _make_layer5(self, block, planes, blocks, kernel_size, stride=2):
        ...
        layers = [block(self.inplanes5, planes, kernel_size, stride, downsample)]
    ...
    def _make_layer7(self, block, planes, blocks, kernel_size, stride=2):
        ...
        layers = [block(self.inplanes7, planes, kernel_size, stride, downsample)]
...
if __name__ == '__main__':
    ...
    x = torch.randn(1280, 4, 32, 32)
    net = ms_resnet_34()
    y = net(x)
    # summary(net, (32, 128))
    print(y.shape)  # result is [1280, 2]
